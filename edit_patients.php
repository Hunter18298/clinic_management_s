...
<script src="https://code.jquery.com/jquery-3.6.1.js" integrity="sha256-3zlB5s2uwoUzrXK3BT7AX3FyvojsraNFxCc2vC/7pNI="
  ...
  <body>
    ...
    <form action="update_patients.php" method="post" enctype="multipart/form-data">
    <div class="container-fluid">
...
<input type="text" name="dentist_name" id="dentist_name" value="<?php echo $row['dentist_username'] ?>" autocomplete="off"><br>
<input type="text" name="dentist_name" id="dentist_name" value="<?php echo $row['patient_id'] ?>" autocomplete="off"><br>
